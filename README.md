...
<!--
**Hamza6210/Hamza6210** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
Currently working on an ERP system <br>
But you can also ask me about a CRM 💬

<br>
🛠️ Tools & Technologies

Frontend: HTML, CSS, JavaScript, React, Next.js, Tailwind CSS, Bootstrap <br>
Backend: Node.js, Express.js <br>
Database: PostgreSQL, MySQL <br>
CMS: WordPress (Elementor, Custom Development) <br>
